...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("tf_categories" == $this->chrt_array['tables'][0])
			return true;
		if("tf_resources" == $this->chrt_array['tables'][0])
			return true;
		if("tf_events" == $this->chrt_array['tables'][0])
			return true;
		if("tf_settings" == $this->chrt_array['tables'][0])
			return true;
		if("tf_clients" == $this->chrt_array['tables'][0])
			return true;
		if("tf_events" == $this->chrt_array['tables'][0])
			return true;
		return false;
