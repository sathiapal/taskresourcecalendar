...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "broadspireatcrmcluster8cg8qeeg";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "tf_categories" ] = array( "url" => "tf_categories", "type" => 0 );
	$projectEntitiesReverse[ "tf_categories" ] = "tf_categories";
	$projectEntities[ "tf_resources" ] = array( "url" => "tf_resources", "type" => 0 );
	$projectEntitiesReverse[ "tf_resources" ] = "tf_resources";
	$projectEntities[ "tf_events" ] = array( "url" => "tf_events", "type" => 0 );
	$projectEntitiesReverse[ "tf_events" ] = "tf_events";
	$projectEntities[ "tf_settings" ] = array( "url" => "tf_settings", "type" => 0 );
	$projectEntitiesReverse[ "tf_settings" ] = "tf_settings";
	$projectEntities[ "tf_clients" ] = array( "url" => "tf_clients", "type" => 0 );
	$projectEntitiesReverse[ "tf_clients" ] = "tf_clients";
	$projectEntities[ "tf_clients_resourcecalendar" ] = array( "url" => "tf_clients_resourcecalendar", "type" => 1 );
	$projectEntitiesReverse[ "tf_clients_resourcecalendar" ] = "tf_clients_resourcecalendar";
}
