...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "broadspireatcrmcluster8cg8qeeg" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["tf_categories"] = "broadspireatcrmcluster8cg8qeeg";
		$connectionsIds["tf_resources"] = "broadspireatcrmcluster8cg8qeeg";
		$connectionsIds["tf_events"] = "broadspireatcrmcluster8cg8qeeg";
		$connectionsIds["tf_settings"] = "broadspireatcrmcluster8cg8qeeg";
		$connectionsIds["tf_clients"] = "broadspireatcrmcluster8cg8qeeg";
		$connectionsIds["tf_clients_resourcecalendar"] = "broadspireatcrmcluster8cg8qeeg";
