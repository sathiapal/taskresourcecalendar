...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="tf_clients_resourcecalendar" && $field=="start")
	{
		return $_GET['starttime'];
	}
				if($table=="tf_clients_resourcecalendar" && $field=="end")
	{
		return $_GET['endtime'];
	}
				if($table=="tf_clients_resourcecalendar" && $field=="resource_id")
	{
